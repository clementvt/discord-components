...
In version 4.x of @clementvt/discord-components-core, the library has been
rewritten from from [StencilJS](https://stenciljs.com) to [Lit]. This means that
this library now offers proper
...
```ts
import '@clementvt/discord-components-core/discord-messages';
import '@clementvt/discord-components-core/discord-message';
```
