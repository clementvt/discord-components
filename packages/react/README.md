...
# @clementvt/discord-components-react

**React bindings for
[@clementvt/discord-components-core](https://github.com/skyra-project/discord-components/tree/main/packages/core)**
...
- [@clementvt/discord-components-react](#skyradiscord-components-react)
...
```bash
yarn add @clementvt/discord-components-core @clementvt/discord-components-react
# or npm install @clementvt/discord-components-core @clementvt/discord-components-react
```
